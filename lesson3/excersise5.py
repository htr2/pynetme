...
WINDOWS = True          # Toggle this to use Windows/Linux
base_ip = "192.168.0."  # Edit this to fit your environment
base_cmd_linux = 'ping -c 2'
base_cmd_windows = 'ping -n 2'
...
for ip_addr in ip_list:
    ...
    return_code = os.system("ping -n 1 {}".format(ip_addr))
    print('-' * 80)
print('-' * 80)
